...
void draw_3d_model_simple(ThreadPool & threadPool, ModelPtrArray const& models, TGAImage & frame, float * zbuffer)
{
...
int main(int argc, char** argv) 
{
    ...
    window.do_on_idle([&]()
    {
        ...
        draw_3d_model_simple(threadPool, models, *pFrame, zbuffer.get());
